...
import { ColDef, TimeLine, RowData, GanttStyleOption, TimePoint } from 'vue-gantt-3/types';
...
const onTimePointMoveFinished = (timePoint: TimePoint, date: Dayjs) => {
  console.log('onTimePointMoveFinished', timePoint, date);
};
